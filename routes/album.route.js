...
const { createAlbum, updateAlbum, deleteAlbum, getAlbums, getParticularAlbum, shareAlbums } = require("../controllers/album.controller");
...
albumRouter.post("/:id/share", verifyMiddleware, isOwner, shareAlbums);
